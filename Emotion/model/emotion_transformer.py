...
MAIA = ["empathy","happiness","neutral","disappointment","confusion","frustration","anger","anxiety"]
...
class EmotionTransformer(pl.LightningModule):
    ...
    def __init__(self, hparams: Namespace):
        ...
        if self.config.labels == "maia":
            self.label_encoder = {MAIA[i]: i for i in range(len(MAIA))}
        else:
    ...
    def test_epoch_end(
        ...
        matrix = confusion_matrix(y_labels,y_hat_predictions)
        print(matrix)
